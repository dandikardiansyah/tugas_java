...
int tanggal;
int Bulan;
tanggal26 = JOptionPane.showInputDialog("inputkan Tanggal Lahir Anda : ");
tanggal = Integer.parseInt(tanggal26);
Bulan6 = JOptionPane.showInputDialog("Inputkan Hari Lahir Anda :");
Bulan = Integer.parseInt(Bulan6);
